namespace Maquetas
{
  partial class frmMain
  {
    ...
    private void InitializeComponent()
    {
      ...
      // ribMain
      // 
      this.ribMain.ApplicationCaption = "Sistema HID";
      this.ribMain.ApplicationDocumentCaption = "Pantalla Principal";
      ...
      this.ribMain.ShowApplicationButton = DevExpress.Utils.DefaultBoolean.False;
      ...
      this.Text = "Pantalla Principal - Sistema HID";
