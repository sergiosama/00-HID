namespace HidUI.Views
{
  partial class StartView
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.tileControl2.ItemPadding = new System.Windows.Forms.Padding(20);
      this.tileControl2.Location = new System.Drawing.Point(0, 0);
      this.tileControl2.Margin = new System.Windows.Forms.Padding(20);
      ...
      this.tileControl2.Size = new System.Drawing.Size(801, 479);
      this.tileControl2.TabIndex = 0;
      this.tileControl2.Text = "tileControl2";
      this.tileControl2.VerticalContentAlignment = DevExpress.Utils.VertAlignment.Center;
      // 
      // tileGroup2
      // 
      this.tileGroup2.Items.Add(this.tileStock);
      ...
      // tileStock
      // 
      this.tileStock.ContentAnimation = DevExpress.XtraEditors.TileItemContentAnimationType.Fade;
      ...
      this.tileStock.Elements.Add(tileItemElement1);
      this.tileStock.Elements.Add(tileItemElement2);
      this.tileStock.Elements.Add(tileItemElement3);
      this.tileStock.Id = 4;
      this.tileStock.ItemSize = DevExpress.XtraEditors.TileItemSize.Wide;
      this.tileStock.Name = "tileStock";
      this.tileStock.ItemClick += new DevExpress.XtraEditors.TileItemClickEventHandler(this.Stock_Navigator_Click);
      // 
      // tileItem1
      // 
      ...
      // tileItem2
      // 
      tileItemElement5.Text = "tileItem2";
      ...
      // tileItem3
      // 
      tileItemElement6.Text = "tileItem3";
